...
var blazy = new Blazy({
  ...
  success: function success(ele) {
    if (window.screen.width > 768) {
      (0, _helpers.addClass)(ele, 'lazyloaded--desktop');
      if ((0, _helpers.hasClass)(ele, 'splash__background')) {
        (function () {
          ...
          var splashMask = tempDiv.firstChild;

          var splashBackground = document.querySelector('.splash__background');
          splashBackground.appendChild(splashMask);
          setTimeout(function () {
            (0, _helpers.addClass)(splashMask, 'is-animated');
          }, 100);
        })();
      }
    }
...
var tlBox1 = new TimelineMax({ repeat: -1 });
var box1 = document.querySelector('.graphic--prototyping__box--01');
tlBox1.add(TweenMax.fromTo(box1, .25, { width: 52, fill: '#555', stroke: '#bbb' }, { width: 86, fill: '#F24C27', stroke: '#F24C27', transformOrigin: "left center", delay: .125 }));
tlBox1.add(TweenLite.to(box1, .25, { width: 52, fill: '#555', stroke: '#bbb', delay: 2.75 }));
tlBox1.add(TweenLite.to(box1, 2.625, { width: 52 }));

var tlBox2 = new TimelineMax({ repeat: -1 });
var box2 = document.querySelector('.graphic--prototyping__box--02');
...
try {
  for (var _iterator = graphicProjects[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    var tlDevice = new TimelineMax({ repeat: -1 });
...
},{"./lib/_helpers":5,"./lib/_nodelist-shim":6,"blazy":1,"es6-shim":2}],5:[function(require,module,exports){
'use strict';
